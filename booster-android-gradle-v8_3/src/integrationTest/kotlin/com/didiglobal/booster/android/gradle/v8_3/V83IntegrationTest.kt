...
abstract class V83IntegrationTest(private val isLib: Boolean) {
    ...
    val ruleChain: TestRule = rule(projectDir) {
        rule(LocalProperties(projectDir::getRoot)) {
            GradleExecutor(projectDir::getRoot, "8.4", *ARGS.toTypedArray())
        }
    }
...
class V83AppIntegrationTest : V83IntegrationTest(false)

class V83LibIntegrationTest : V83IntegrationTest(true)
