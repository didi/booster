...
abstract class V86IntegrationTest(private val isLib: Boolean) {
...
class V86AppIntegrationTest : V86IntegrationTest(false)

class V86LibIntegrationTest : V86IntegrationTest(true)
