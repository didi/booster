...
abstract class V84IntegrationTest(private val isLib: Boolean) {
    ...
    val ruleChain: TestRule = rule(projectDir) {
        rule(LocalProperties(projectDir::getRoot)) {
            GradleExecutor(projectDir::getRoot, "8.6", *ARGS.toTypedArray())
        }
    }
...
class V84AppIntegrationTest : V84IntegrationTest(false)

class V84LibIntegrationTest : V84IntegrationTest(true)
