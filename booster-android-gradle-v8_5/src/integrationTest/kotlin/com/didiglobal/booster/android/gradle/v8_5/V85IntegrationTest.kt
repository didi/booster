...
abstract class V85IntegrationTest(private val isLib: Boolean) {
    ...
    val ruleChain: TestRule = rule(projectDir) {
        rule(LocalProperties(projectDir::getRoot)) {
            GradleExecutor(projectDir::getRoot, "8.7", *ARGS.toTypedArray())
        }
    }
...
class V85AppIntegrationTest : V85IntegrationTest(false)

class V85LibIntegrationTest : V85IntegrationTest(true)
