...
abstract class V89IntegrationTest(private val isLib: Boolean) {
    ...
    fun setup() {
        ...
        assertEquals(9, AGP.revision.minor)
    }
...
class V89AppIntegrationTest : V89IntegrationTest(false)

class V89LibIntegrationTest : V89IntegrationTest(true)
