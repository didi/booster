...
class JavassistTransformer : Transformer {
    ...
    constructor(classLoader: ClassLoader) : this(classLoader, ServiceLoader.load(ClassTransformer::class.java, classLoader).sortedBy {
        it.javaClass.getAnnotation(Priority::class.java)?.value ?: 0
    })

    constructor(classLoader: ClassLoader, transformers: Iterable<ClassTransformer>) {
