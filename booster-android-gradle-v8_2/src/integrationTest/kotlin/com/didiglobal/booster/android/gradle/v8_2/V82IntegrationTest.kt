...
abstract class V82IntegrationTest(private val isLib: Boolean) {
    ...
    val ruleChain: TestRule = rule(projectDir) {
        rule(LocalProperties(projectDir::getRoot)) {
            GradleExecutor(projectDir::getRoot, "8.2", *ARGS.toTypedArray())
        }
    }
...
class V82AppIntegrationTest : V82IntegrationTest(false)

class V82LibIntegrationTest : V82IntegrationTest(true)
